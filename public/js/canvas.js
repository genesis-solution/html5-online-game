...
// Function to draw the countdown timer on the canvas
function drawCountdown(ctx, timeInSeconds) {
    ...
    ctx.font = "30px Arial";
    ctx.fillText(minutes.toString().padStart(2, '0') + ":" + seconds.toString().padStart(2, '0'), 50, 50);
}
...
function buildGameCanvas(response){
	...
	itemTimerDown = new createjs.Bitmap(loader.getResult('itemTimerDown'));
	centerReg(itemTimerDown);
